...
converting them to the NOT PORTED form means looking each one up in reverse-engineering/export/,
which is a judgement call rather than a rewrite.

Usage: python reverse-engineering/tools/migrate-headers.py [path] [--apply]
"""
import os
import re
import sys
