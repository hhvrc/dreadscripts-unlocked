...
internal static class SupporterStrings
{
	...
	internal static readonly string[] HeaderTooltips = new string[14]
	{
	...
	internal static readonly string[] SupporterTooltips = new string[23]
	{
