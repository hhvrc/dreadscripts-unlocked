...
internal struct AxisControlSettings
{
	...
	public static AxisControlSettings allowed = new AxisControlSettings(Axis.X | Axis.Y | Axis.Z, OptionState.Allowed, OrientationState.Both);

	public static AxisControlSettings forced = new AxisControlSettings(OptionState.Forced);

	public static AxisControlSettings off = new AxisControlSettings(OptionState.Off);
	...
	public bool IsEnabled(bool islast)
	{
	...
	public PivotRotation ResolvePivotRotation(PivotRotation instance)
	{
