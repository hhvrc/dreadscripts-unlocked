...
// means both go stale when VRChat adds to them, and the entries at the end of reservedAvatarParameters
// (AvatarVersion onwards) show which SDK generation this snapshot was built against.
//
// The tool treats a parameter whose name is in reservedAvatarParameters as one it must not rename,
