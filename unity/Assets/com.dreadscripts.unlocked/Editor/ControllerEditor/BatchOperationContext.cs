...
namespace DreadScripts.ControllerEditor
{
    ...
    internal struct BatchOperationContext
    {
        ...
        internal BatchOperationContext Reset()
        {
            ...
            // The shipped build spun forever here: it looped while the progress bar flag was set but
            // never cleared it, so any reset after a progress bar had been shown hung the editor.
            if (progressBarShown)
            {
                EditorUtility.ClearProgressBar();
